...
public class AiToolService {
    ...
    public ToolActionResponse familyAlert(FamilyAlertRequest req) {
        log.info("tool[send_family_sms_alert] 수신: callId={}, userId={}, scenario={}, riskScore={}, guardianIds={}",
                req.callId(), req.userId(), req.scenario(), req.riskScore(), req.guardianIds());
    ...
    public ToolActionResponse warningBanner(WarningBannerRequest req) {
        log.info("tool[show_warning_banner] 수신: callId={}, userId={}, scenario={}, riskScore={}",
                req.callId(), req.userId(), req.scenario(), req.riskScore());
        // TODO: 실제 FCM/GPS/증거저장/경찰신고 연동 지점
        return ToolActionResponse.ok("show_warning_banner");
    }

    public ToolActionResponse saveEvidence(EvidenceRequest req) {
        log.info("tool[save_evidence] 수신: callId={}, userId={}, scenario={}, riskScore={}",
                req.callId(), req.userId(), req.scenario(), req.riskScore());
        // TODO: 실제 FCM/GPS/증거저장/경찰신고 연동 지점
    ...
    public ToolActionResponse notifyPolice(PoliceReportRequest req) {
        log.info("tool[notify_police] 수신: callId={}, userId={}, incidentType={}, riskScore={}",
                req.callId(), req.userId(), req.incidentType(), req.riskScore());
        // TODO: 실제 FCM/GPS/증거저장/경찰신고 연동 지점
        return ToolActionResponse.ok("notify_police");
    }

    public ToolActionResponse familyGps(GpsRequest req) {
        log.info("tool[check_family_gps] 수신: callId={}, userId={}", req.callId(), req.userId());
        // TODO: 실제 FCM/GPS/증거저장/경찰신고 연동 지점
